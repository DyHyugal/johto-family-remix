...
[Home](Home.md) · [Game Guide](Game-Guide.md) · [Changes](Changes.md) · [Bosses & Tips](Bosses-and-Tips.md) · [Pokédex & Locations](Pokedex-and-Locations.md) · [Credits & Versions](Credits-and-Versions.md) · **[FR](../FR/Changements.md)**

# Changes

This page groups the main differences between Pokémon Heart & Soul and Pokémon Family Remix. The goal is to avoid a wiki full of tiny nested pages.
...
Elm's Egg becomes a second Family Remix selection: the confirmed species is the actual Pokémon inside the Egg and keeps its identity through hatching.
...
Family Remix keeps the HnS visual base and finishes a lighter V1 refresh across:
